...
var DashboardComponent = (function () {
    function DashboardComponent(router, activatedRoute, eventService, userService) {
        this.router = router;
...
var EventService = (function () {
    ...
    EventService.prototype.findEventsInterested = function (userId) {
        var url = this.baseUrl + '/api/user/' + userId + '/dashboard/intrstEvents';
